 ...
 *
 */
@Operation(id = VerifyBinaryHash.ID, category = Constants.CAT_BLOB, label = "Check Binary by Hash", description = "Check to see if the binary is found within the system. Returns the same digest if found, null otherwise.")
